...
#define EXP_SLOW(n)(((5 * CUBE(n)) / 4) - (10 * n)) // (5 * (n)^3) / 4
#define EXP_FAST(n)(((4 * CUBE(n)) / 5) - (10 * n)) // (4 * (n)^3) / 5
#define EXP_MEDIUM_FAST(n)(CUBE(n) - (10 * n)) // (n)^3
#define EXP_MEDIUM_SLOW(n)((6 * CUBE(n)) / 5 - (15 * SQUARE(n)) + (100 * n) - 140- (10 * n))    // (6 * (n)^3) / 5 - (15 * (n)^2) + (100 * n) - 140
