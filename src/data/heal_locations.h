static const struct HealLocation sSpawnPoints[] =
{
    ...
    [SPAWN_ROUTE_23 - 1] = {MAP_GROUP(ROUTE23), MAP_NUM(ROUTE23), 0, 0},
    [SPAWN_ROUTE_24 - 1] = {MAP_GROUP(ROUTE24), MAP_NUM(ROUTE24), 0, 0},
    [SPAWN_ROUTE_25 - 1] = {MAP_GROUP(ROUTE25), MAP_NUM(ROUTE25), 0, 0},
    [SPAWN_ROUTE_49 - 1] = {MAP_GROUP(ROUTE49), MAP_NUM(ROUTE49), 0, 0},
    [SPAWN_ROUTE_51 - 1] = {MAP_GROUP(ROUTE51), MAP_NUM(ROUTE51), 0, 0},
};
