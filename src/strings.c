...
const u8 gText_BuyOne[] = _("{STR_VAR_1}? Certainly.");
...
const u8 gText_OhNoICantBuyThatTM[] = _("Sorry, I don't buy\nTMs or HMs.{PAUSE_UNTIL_PRESS}");
...
const u8 gText_50Coins_1000[] = _("{SMALL} 50 COINS{CLEAR_TO 0x45}¥500");
const u8 gText_500Coins_10000[] = _("{SMALL}500 COINS{CLEAR_TO 0x45}¥5,000");
...
const u8 gText_Pinsir_5500Coins[] = _("PINSIR{CLEAR_TO 0x4B}{SMALL} 5,500 Coins");
...
const u8 gText_MiracleSeed_1000Coins[] = _("RARE CANDY{CLEAR_TO 0x5A}{SMALL}200 COINS");
const u8 gText_Charcoal_1000Coins[] = _("MAX REVIVE{CLEAR_TO 0x5A}{SMALL}333 COINS");
const u8 gText_MysticWater_1000Coins[] = _("FULL RESTORE{CLEAR_TO 0x5A}{SMALL}333 COINS");
...
const u8 gText_RegionMap_AreaDesc_CinnabarVolcano[] = _("An ancient, dormant\n volcano filled with powerful\n Pokemon.");
