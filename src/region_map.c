...
static const u16 sMapSectionTopLeftCorners[MAPSEC_COUNT][2] = {
    ...
    [MAPSEC_CELADON_FOREST      - MAPSECS_KANTO] = {11,  5},
    [MAPSEC_HEMLOCK_TOWN            - MAPSECS_KANTO] = {13, 14},
};
...
static const u8 sRegionMapSections_Kanto[LAYER_COUNT][MAP_HEIGHT][MAP_WIDTH] = {
    [LAYER_MAP] = 
    {
        ...
        {MAPSEC_NONE, MAPSEC_NONE, MAPSEC_ROUTE_23, MAPSEC_NONE, MAPSEC_ROUTE_2, MAPSEC_NONE, MAPSEC_NONE, MAPSEC_NONE, MAPSEC_NONE, MAPSEC_NONE, MAPSEC_NONE, MAPSEC_CELADON_FOREST, MAPSEC_NONE, MAPSEC_NONE, MAPSEC_ROUTE_5, MAPSEC_NONE, MAPSEC_NONE, MAPSEC_NONE, MAPSEC_ROUTE_10, MAPSEC_NONE, MAPSEC_NONE, MAPSEC_NONE},
